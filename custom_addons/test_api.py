...
def test_api_endpoints():
    ...
    try:
        ...
        response = requests.post(f"{base_url}/web/session/authenticate", json=login_data, headers=headers)
        ...
        try:
            response = requests.get(f"{base_url}/web/health", headers=headers, timeout=5)
