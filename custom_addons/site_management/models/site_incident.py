...
class SiteIncident(models.Model):
    ...
    state = fields.Selection([
        ...
        ('resolved', 'Resuelto'),
        ('closed', 'Cerrado')
    ], string='Estado', default='reported', required=True, tracking=True)
    ...
    def create(self, vals):
        if not vals.get('name'):
            incident_type = dict(self._fields['incident_type'].selection).get(vals.get('incident_type'), 'Incidente')
