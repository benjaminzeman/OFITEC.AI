...
class AIAnalyticsAPI(http.Controller):
    ...
    def predict(self, **kwargs):
        ...
        try:
            ...
            if not ai_model:
                return self._error_response(f"No trained model found for type: {model_type}")
    ...
    @http.route('/api/v1/ai/analytics/predictive', type='json', auth='user', methods=['GET'])
    ...
    @http.route('/api/v1/ai/analytics/realtime', type='json', auth='user', methods=['GET'])
        ...
        try:
            ...
            for model in models:
                model_list.append({
                    ...
                    'last_trained': model.training_date and model.training_date.isoformat()
                })
    ...
    @http.route('/api/v1/ai/models/<int:model_id>/train', type='json', auth='user', methods=['POST'])
    ...
    @http.route('/api/v1/ai/models/<int:model_id>/features', type='json', auth='user', methods=['GET'])
    ...
    @http.route('/api/v1/ai/insights/<int:project_id>', type='json', auth='user', methods=['GET'])
        ...
        try:
            ...
            return self._success_response({
                'project': {
                    'id': project.id,
                    'name': project.name,
                    'status': project.stage_id.name if project.stage_id else 'Unknown'
                },
    ...
    @http.route('/api/v1/ai/dashboard/summary', type='json', auth='user', methods=['GET'])
    ...
    @http.route('/api/v1/ai/webhook/<string:service>', type='json', auth='public', methods=['POST'], csrf=False)
...
class AIWebhookController(http.Controller):
    ...
    @http.route('/api/v1/ai/webhook/powerbi/refresh', type='json', auth='public', methods=['POST'], csrf=False)
    ...
    @http.route('/api/v1/ai/webhook/tableau/alert', type='json', auth='public', methods=['POST'], csrf=False)
...
class AISecurityController(http.Controller):
    ...
    @http.route('/api/v1/ai/auth/token', type='json', auth='public', methods=['POST'], csrf=False)
